let scheme = {
	"0": { // номер конкурса
		...
		"achievements": { // ачивки конкурса (структура аналогична "themes" + дополнительные поля)
			"gifts": [], // призы за ачивки. "" означает, что приз неизвестен
			"win": [] // игры, получившие ачивки. "" означает, что ачивку не получила ни одна игра
		},
