		...
		"games": [
			{
				...
				"status": "", // статус игры (номер места (от 1 до 3), "win" (если победитель конкурса только один), "final" (если прислана финальная версия), "demo" (если прислана только демо-версия), "updated" (если есть данные только об обновлённой финальной версии), "dlc" (если DLC) и "disqualified" (если игра дисквалифицирована с конкурса))
