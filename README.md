...
Находится в директории `src/`, также является базовой. Описание схемы находится в файле `schema.json`.
В директории `dist/` доступны минифицированные версии файлов.
